...
<hr />
<br />
<div className="flex-row lg:flex bg-gray-300 py-20 p-8">
      <div className="text-center">
        <RiEBike2Fill className=" ml-80 lg:ml-44 text-2xl"></RiEBike2Fill>
        <h1 className="text-2xl font-bold text-black">Free Free Delivery</h1>
        <h3 className="text-xl font-semibold">  And free returns. See checkout for delivery dates.</h3>
      </div>

      <div className="text-center">
        <RiBankCardFill className="ml-80 lg:ml-52 text-2xl"></RiBankCardFill>
      ...
      <div className="text-center">
        <RiShakeHandsFill className="ml-80 lg:ml-40 text-2xl "></RiShakeHandsFill>
      ...
      <div className="text-center">
        <RiCustomerService2Fill className="ml-80 lg:ml-44  text-2xl "></RiCustomerService2Fill>
